...
{
    VkMutableTypeDescriptorListVALVE mutable_descriptor_list[VKD3D_BINDLESS_SET_MAX_EXTRA_BINDINGS + 1];
...
static bool vkd3d_bindless_supports_mutable_type(struct d3d12_device *device)
{
    ...
    VkMutableTypeDescriptorListVALVE mutable_list;
        ...
        struct d3d12_device *device)
{
    ...
    {
        INFO("Device supports VK_VALVE_mutable_descriptor_type :3\n");
